...
(assert true)
(assert true)
(assert (and (<= MEM!9 MEM!13) (<= bitwise!start MEM!13) (= (mod (mod MEM!13 5) prime) 0)))
(assert true)
(assert true)
(assert true)
(assert true)
(assert (not (and (<= MEM!22 MEM!21) (<= bitwise!start MEM!21) (= (mod (mod MEM!21 5) prime) 0) (<= bitwise!start MEM!9) (= (mod (mod MEM!9 5) prime) 0) (<= MEM!13 bitwise!end))))
(check-sat)