...
Kindly note, Horus is currently in the alpha stage. No guarantee is being given
as to the accuracy and/or completeness of any of the outputs the tool may
generate. The tool is provided on an 'as is' basis, without warranties or
conditions of any kind, either express or implied, including without limitation
in respect of the outputs of the verification process and the security of any
system verified using Horus. As per the Apache 2.0 license applied to the
project, Nethermind disclaims any liability in connection with your use of
Horus and any of its outputs, to the fullest extent permitted by law.

Please also note that the terminology used by Horus, including but not limited
to words such as 'guarantee', should be interpreted strictly within the context
of formal verification. These words are not intended to, and shall not be
construed as having legal meaning of any kind.

For avoidance of doubt, the outputs generated by Horus and/or your usage
thereof shall not be considered or relied upon as any form of financial,
investment, tax, legal, regulatory, or other advice.
