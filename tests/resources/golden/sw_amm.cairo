# Taken from - https://github.com/starkware-libs/cairo-lang/blob/master/src/starkware/starknet/apps/amm_sample/amm_sample.cairo
%lang starknet
...
# @post new_balance < BALANCE_UPPER_BOUND
func modify_account_balance{range_check_ptr}(
    balance : felt, account_id : felt, token_type : felt, amount : felt
) -> (new_balance) :
