...
namespace SafeUint256 {
    ...
    // @pre a == $a and b == $b
    // @post $a + $b == $Return.c
    // The above syntax does not work, and we cannot call functions in assertions :(
...
func erc20_total_supply{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}() -> (
...
func erc20_balance_of{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    account: felt
) -> (balance: Uint256) {
...
func erc20_transfer_from{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func erc20_increase_allowance{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func erc20_decrease_allowance{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func _erc20_mint{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    recipient: felt, amount: Uint256
) {
    with_attr error_message("ERC20: amount is not a valid Uint256") {
        uint256_check(amount);
...
func _erc20_burn{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func _erc20_transfer{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    sender: felt, recipient: felt, amount: Uint256
) {
    with_attr error_message("ERC20: amount is not a valid Uint256") {
...
func _erc20_approve{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
...
func _erc20_spend_allowance{syscall_ptr: felt*, pedersen_ptr: HashBuiltin*, range_check_ptr}(
    owner: felt, spender: felt, amount: Uint256
) {
    alloc_locals;
    with_attr error_message("ERC20: amount is not a valid Uint256") {
