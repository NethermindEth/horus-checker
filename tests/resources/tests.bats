...
@test "./tests/resources/golden/inline_balance_svar_simple_asm" {
    test_case "./tests/resources/golden/inline_balance_svar_simple_asm"
}

@test "./tests/resources/golden/inline_balance_svar_simple" {
    test_case "./tests/resources/golden/inline_balance_svar_simple"
}

@test "./tests/resources/golden/inline_balance_svar_simple_twice" {
    test_case "./tests/resources/golden/inline_balance_svar_simple_twice"
}
...
@test "./tests/resources/golden/inline_svar" {
    test_case "./tests/resources/golden/inline_svar"
}

@test "./tests/resources/golden/inline_svar_read_write" {
    test_case "./tests/resources/golden/inline_svar_read_write"
}

@test "./tests/resources/golden/inline_svar_read_write_many" {
    test_case "./tests/resources/golden/inline_svar_read_write_many"
}

@test "./tests/resources/golden/inline_svar_sat" {
    test_case "./tests/resources/golden/inline_svar_sat"
}
