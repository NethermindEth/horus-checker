...
test_case() {
    ...
    horus-compile "$test_file" --cairo_path=./tests/resources/golden/ > "$compiled_file"
    stack run horus-check "$compiled_file" -- -s mathsat -s z3 -t 20000 &> "$temp_file" || true
...
@test "./tests/resources/golden/get_block_timestamp" {
    test_case "./tests/resources/golden/get_block_timestamp"
}

@test "./tests/resources/golden/get_block_timestamp_demo" {
    test_case "./tests/resources/golden/get_block_timestamp_demo"
}

@test "./tests/resources/golden/get_caller_address" {
    test_case "./tests/resources/golden/get_caller_address"
}

@test "./tests/resources/golden/get_contract_address" {
    test_case "./tests/resources/golden/get_contract_address"
}
...
@test "./tests/resources/golden/math" {
    test_case "./tests/resources/golden/math"
}
...
@test "./tests/resources/golden/toy_amm" {
    test_case "./tests/resources/golden/toy_amm"
}
