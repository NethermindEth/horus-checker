...
(assert (= ADDR!9 (mod (+ ap!<root>@6 22) prime)))
(assert (= ADDR!10 (mod (+ ap!<root>@6 20) prime)))
(assert (= ADDR!11 (mod (+ fp!<64=read/root> (- 4)) prime)))
(assert (= ADDR!12 (mod (+ ap!<root>@6 21) prime)))
(assert (= ADDR!13 (mod (+ fp!<64=read/root> (- 3)) prime)))
...
(assert true)
(assert (= MEM!9 __main__.balance))
(assert (< (mod (+ ap!<root>@6 3) prime) (mod (+ ap!<root>@6 23) prime)))
(assert (and (<= pedersen!start MEM!4) (<= MEM!10 pedersen!end)))
(assert true)
(assert true)
(assert true)
(assert (and (<= MEM!11 MEM!10) (<= pedersen!start MEM!10)))
(assert (and (<= range-check!start MEM!6) (<= MEM!12 range-check!end)))
...
(assert (and (<= MEM!13 MEM!12) (<= range-check!start MEM!12)))
(assert (not (and (= MEM!9 __main__.balance) (<= MEM!4 MEM!10) (<= pedersen!start MEM!10) (<= pedersen!start MEM!11) (<= MEM!10 pedersen!end) (<= MEM!6 MEM!12) (<= range-check!start MEM!12) (<= range-check!start MEM!13) (<= MEM!12 range-check!end))))
(check-sat)