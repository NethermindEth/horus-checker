...
(assert (= ADDR!22 (mod (+ fp!<58=write/root> (- 3)) prime)))
(assert (= ADDR!23 (mod (+ ap!<root>@5 44) prime)))
(assert (= ADDR!24 (mod (+ fp!<51=read/root> (- 4)) prime)))
(assert (= ADDR!25 (mod (+ fp!<58=write/root> (- 5)) prime)))
(assert (= ADDR!26 (mod (+ ap!<root>@5 45) prime)))
(assert (= ADDR!27 (mod (+ fp!<51=read/root> (- 3)) prime)))
(assert (= ADDR!28 (mod (+ fp!<58=write/root> (- 4)) prime)))
...
(assert (and (<= pedersen!start MEM!6) (<= MEM!23 pedersen!end)))
(assert true)
(assert true)
(assert true)
(assert (and (<= MEM!24 MEM!16) (<= pedersen!start MEM!16)))
(assert true)
(assert true)
(assert true)
(assert true)
(assert (=> (or (<= pedersen!start MEM!12) (<= pedersen!start MEM!1)) (= (+ MEM!12 MEM!1) (mod (+ MEM!12 MEM!1) prime))))
(assert (and (<= MEM!25 MEM!23) (<= pedersen!start MEM!23)))
(assert (and (<= range-check!start MEM!8) (<= MEM!26 range-check!end)))
...
(assert (and (<= MEM!27 MEM!18) (<= range-check!start MEM!18)))
...
(assert (and (<= MEM!28 MEM!26) (<= range-check!start MEM!26)))
(assert (not (and (<= MEM!6 MEM!23) (<= pedersen!start MEM!23) (<= pedersen!start MEM!24) (<= MEM!16 pedersen!end) (<= pedersen!start MEM!25) (<= MEM!23 pedersen!end) (<= MEM!8 MEM!26) (<= range-check!start MEM!26) (<= range-check!start MEM!27) (<= MEM!18 range-check!end) (<= range-check!start MEM!28) (<= MEM!26 range-check!end) (= MEM!22 (mod (+ __main__.balance MEM!1) prime)) (= (mod (+ __main__.balance MEM!1) prime) MEM!22))))
(check-sat)